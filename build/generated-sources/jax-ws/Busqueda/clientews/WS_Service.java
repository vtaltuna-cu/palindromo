    ...
    extends Service
{
    ...
    private final static QName WS_QNAME = new QName("http://webservices/", "WS");
    ...
    public WS getWSPort() {
        return super.getPort(new QName("http://webservices/", "WSPort"), WS.class);
    }
    ...
    public WS getWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices/", "WSPort"), WS.class, features);
    }
