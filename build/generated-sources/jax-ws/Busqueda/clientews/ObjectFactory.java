 ...
 * generated in the Busqueda.clientews package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetProducts_QNAME = new QName("http://webservices/", "getProducts");
    private final static QName _GetProductsResponse_QNAME = new QName("http://webservices/", "getProductsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: Busqueda.clientews
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "getProducts")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "getProductsResponse")
